...
route.post('/post', function(req, res, next){
  ...
  pool.query('insert into post_content (post, zip, up_votes, down_votes, score, upvoted, downvoted, date) values ($1::text, $2::text, $3::int, $4::int, $5::int, $6::text)', [data.post, data.zip, 0, 0, 0, d]).then(function(){
